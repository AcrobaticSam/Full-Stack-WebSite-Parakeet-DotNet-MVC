...
namespace Parakeet.Web.Controllers
{
    public class SharedController : Controller
    {
        ...
        public JsonResult UploadImage3()
        {
            JsonResult result = new JsonResult();
            result.JsonRequestBehavior = JsonRequestBehavior.AllowGet;
            ...
            try
            {
                ...
                result.Data = new { Success = true, ImageURL3 = string.Format("/content/images/{0}", fileName) };
        ...
        public JsonResult UploadImage4()
        {
            JsonResult result = new JsonResult();
            result.JsonRequestBehavior = JsonRequestBehavior.AllowGet;
            ...
            try
            {
                ...
                result.Data = new { Success = true, ImageURL4 = string.Format("/content/images/{0}", fileName) };
