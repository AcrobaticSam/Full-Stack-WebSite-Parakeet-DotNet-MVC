...
namespace Parakeet.Web.Controllers
{
    public class ShopController : Controller
    {
        ...
        public ActionResult Wiki(string searchTerm, int? minimumPrice, int? maximumPrice, int? categoryID, int? sortBy, int? pageNo)
        {
            var pageSize = ConfigurationsService.Instance.ShopPageSize();
        ...
        public ActionResult FilterWiki(string searchTerm, int? minimumPrice, int? maximumPrice, int? categoryID, int? sortBy, int? pageNo)
        {
            var pageSize = ConfigurationsService.Instance.ShopPageSize();
